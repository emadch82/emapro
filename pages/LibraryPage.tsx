...
const LibraryPage: React.FC<LibraryPageProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-background z-[1500] animate-fadeIn flex flex-col">
      <header className="flex-shrink-0 flex items-center p-3 border-b border-border-color bg-card-bg shadow-sm">
        ...
        <h2 className="font-bold text-lg mr-4">کتابخانه</h2>
      </header>
      <main className="flex-grow overflow-y-auto p-4">
        <div className="text-center py-20 text-text-secondary">
          <i className="fas fa-bookmark text-4xl mb-4 text-primary"></i>
          <p>اپیزودهای ذخیره شده شما در اینجا نمایش داده می‌شوند.</p>
